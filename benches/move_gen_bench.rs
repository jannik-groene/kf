...
fn move_gen_in_opening(c: &mut Criterion<CyclesPerByte>) {
    let mut pos = chess::Position::from_fen(String::from("r3kb1r/1pp1npp1/p1p2q2/4p2p/4P1b1/3P1N1P/PPPN1PP1/R1BQ1RK1 w kq - 3 9")).unwrap();
...
pub fn perft(c: &mut Criterion) {
    ...
    let d = 4;
    c.bench_function("perft 4", |b| b.iter( || {
